...
using UnityEngine;
/// <summary>
/// 从ugui的ScrollRect复制过来，修改一些private为protected，方便继承类修改
/// </summary>
[SelectionBase]
[ExecuteInEditMode]
[DisallowMultipleComponent]
[RequireComponent(typeof(RectTransform))]
public class ScrollViewBase : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
{
    /// <summary>
    /// 添加一个LateUpdate事件
    /// </summary>
    public delegate void LateUpdateFinishedHandler();
    public event LateUpdateFinishedHandler LateUpdateFinished;
    ...
    {
        if (eventData.button != PointerEventData.InputButton.Left || !m_Dragging)
            return;
