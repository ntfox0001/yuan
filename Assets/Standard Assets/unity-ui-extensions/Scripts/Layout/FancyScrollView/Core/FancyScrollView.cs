...
namespace UnityEngine.UI.Extensions
{
    ...
    public abstract class FancyScrollView<TItemData, TContext> : MonoBehaviour where TContext : class, new()
    {
        ...
        /// </summary>
        [SerializeField] protected Transform cellContainer = null;
        ...
        protected IList<TItemData> _ItemSource = new List<TItemData>();

        /// <summary>
        /// <typeparamref name="TContext"/> のインスタンス.
        /// セルとスクロールビュー間で同じインスタンスが共有されます. 情報の受け渡しや状態の保持に使用します.
        /// </summary>
        protected TContext Context { get { return _contex; } }
        protected TContext _contex = new TContext();
